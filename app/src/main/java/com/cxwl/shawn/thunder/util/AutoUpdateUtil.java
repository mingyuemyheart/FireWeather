...
public class AutoUpdateUtil {
	...
	private static void updateDialog(final UpdateDto dto) {
		...
		View view = inflater.inflate(R.layout.shawn_dialog_auto_update, null);
			...
			public void onReceive(Context context, Intent intent) {
				...
				if (id == referneceId) {
					...
					if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
						...
						Uri contentUri = FileProvider.getUriForFile(context, "com.cxwl.shawn.thunder.fileprovider", new File(filePath));
